...
def download_youtube_file(youtube_id: str, series_id: int) -> str:
    ...
    ลำดับ format:
    1. bestvideo[ext=mp4]+bestaudio[ext=m4a] — คุณภาพดีสุด (ต้องมี ffmpeg)
    2. best[ext=mp4][height<=720]            — pre-merged MP4 ≤720p (ไม่ต้องมี ffmpeg)
    3. best[ext=mp4]                          — pre-merged MP4 ใดก็ได้
    ...
    if dl_mode == "spoof":
        # ปลอม User-Agent เป็น Android Chrome ที่ผ่านการตรวจสอบน้อยกว่า bot
        ...
        # ถ้าหา cookies ไม่เจอก็ดาวน์โหลดปกติ (fallback)
